...
//  G7SensorKit
//
//  Embedded Dexcom partner certificates, exchanged in the 0x0B cert step of the direct-auth
//  handshake. Extracted verbatim from the proven G7watchOS client. Public keys only — these
//  are Dexcom's published partner certs (present in the clear in Juggluco), not a per-sensor
//  or per-user secret. The only per-sensor input is the 4-digit pairing code.
//
